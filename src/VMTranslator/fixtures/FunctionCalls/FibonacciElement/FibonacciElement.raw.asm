...
0;JMP -                                                                                                                                 
@SP          // ** 145: function Main.fibonacci 0 **
D=M          // store SP value
@LCL
M=D          // store stack address in LCL (no local vars so we're done) -                                                                                                                                 
@ARG         // ** 146: push argument 0 ** (move to argument)
...
@SP          // increment stack pointer
M=M+1 -                                                                                                                                 
@2           // ** 147: push constant 2 **
D=A          // store the current address as a value
@SP          // >> push constant value (2) onto stack <<
A=M          // move to top of stack
M=D          // write value of D to current location -                                                                                                                                 
@SP          // ** 148: lt ** (pop back to Y, since binary op starts at 1 past Y (SP decremented above))
...
A=M          // move to top of stack
M=-1 -                                                                                                                                 
@SP          // ** 149: if-goto IF_TRUE ** (decrement stack pointer (SP decremented above))
A=M          // move to top of stack
D=M          // store the top stack value into D
@IF_TRUE.VM
D;JNE -                                                                                                                                 
@IF_FALSE.VM // ** 150: goto IF_FALSE **
0;JMP -                                                                                                                                  -                                                                                                                                 
@ARG         // ** 152: push argument 0) ** (move to argument)
D=M          // store the "argument" base address
@0           // move to address representing offset
A=D+A        // new addr = base addr + offset
D=M          // store current memory value in D
...
@SP          // increment stack pointer
M=M+1 -                                                                                                                                 
@LCL         // ** 153: return ** (>>> store LCL as FRAME)
...
0;JMP -                                                                                                                                  -                                                                                                                                 
@ARG         // ** 155: push argument 0) ** (move to argument)
D=M          // store the "argument" base address
@0           // move to address representing offset
A=D+A        // new addr = base addr + offset
D=M          // store current memory value in D
...
@SP          // increment stack pointer
M=M+1 -                                                                                                                                 
@2           // ** 156: push constant 2 **
D=A          // store the current address as a value
@SP          // >> push constant value (2) onto stack <<
A=M          // move to top of stack
M=D          // write value of D to current location -                                                                                                                                 
@SP          // ** 157: sub ** (pop back to Y, since binary op starts at 1 past Y (SP decremented above))
A=M          // PREPARE Y (pop Y into D)
D=M          // store the top stack value into D
@SP          // "pop" X
M=M-1
...
@SP          // increment stack pointer
M=M+1 -                                                                                                                                 
@Main.fibonacci$ret.3 // ** 158: call Main.fibonacci 1 **
D=A          // D=retAddr
@SP          // >>> push retAddr onto stack
A=M          // move to top of stack
M=D          // write value of D to current location
...
0;JMP -                                                                                                                                 
@ARG         // ** 159: push argument 0 ** (move to argument)
D=M          // store the "argument" base address
@0           // move to address representing offset
A=D+A        // new addr = base addr + offset
D=M          // store current memory value in D
...
@SP          // increment stack pointer
M=M+1 -                                                                                                                                 
@1           // ** 160: push constant 1 **
D=A          // store the current address as a value
@SP          // >> push constant value (1) onto stack <<
A=M          // move to top of stack
M=D          // write value of D to current location -                                                                                                                                 
@SP          // ** 161: sub ** (pop back to Y, since binary op starts at 1 past Y (SP decremented above))
A=M          // PREPARE Y (pop Y into D)
D=M          // store the top stack value into D
@SP          // "pop" X
M=M-1
...
@SP          // increment stack pointer
M=M+1 -                                                                                                                                 
@Main.fibonacci$ret.4 // ** 162: call Main.fibonacci 1 **
D=A          // D=retAddr
@SP          // >>> push retAddr onto stack
A=M          // move to top of stack
M=D          // write value of D to current location
...
@Main.fibonacci // jump to the function
0;JMP -                                                                                                                                 
@SP          // ** 163: add ** (pop back to Y, since binary op starts at 1 past Y)
M=M-1
A=M          // PREPARE Y (pop Y into D)
D=M          // store the top stack value into D
@SP          // "pop" X
...
A=M          // prepare to jump to address stored in RET
0;JMP -                                                                                                                                 
@SP          // ** 165: function Sys.init 0 **
D=M          // store SP value
@LCL
M=D          // store stack address in LCL (no local vars so we're done) -                                                                                                                                 
@4           // ** 166: push constant 4 **
D=A          // store the current address as a value
...
@SP          // increment stack pointer
M=M+1 -                                                                                                                                 
@Main.fibonacci$ret.5 // ** 167: call Main.fibonacci 1 **
D=A          // D=retAddr
@SP          // >>> push retAddr onto stack
A=M          // move to top of stack
M=D          // write value of D to current location
