...
(Sys.init$ret.4) // return point for the just-called function
...
(Main.fibonacci$ret.1) // return point for the just-called function
...
(Main.fibonacci$ret.2) // return point for the just-called function
...
(Sys.init)  	// COMMAND #21: function Sys.init 0
	@SP         
	D=M          // store SP value
	@LCL        
	M=D          // store stack address in LCL
	
	// COMMAND #22: push constant 4
	@4          
	D=A          // store the current address as a value
	...
	// COMMAND #23: call Main.fibonacci 1
...
(WHILE.VM)  	// COMMAND #24: label WHILE
	
	// COMMAND #25: goto WHILE
	@WHILE.VM   
	0;JMP       
