...
@Sys.init$ret.4 // ** 0B: CALL Sys.init **
D=A          // D=retAddr
...
A=M          // move to top of stack
M=D          // write value of D to current location
@SP          // ** 4: lt ** (pop back to Y, since binary op starts at 1 past Y (SP decremented above))
...
A=M          // move to top of stack
M=-1
@SP          // ** 5: if-goto IF_TRUE ** (decrement stack pointer (SP decremented above))
A=M          // move to top of stack
D=M          // store the top stack value into D
@IF_TRUE.VM
D;JNE
...
A=M          // move to top of stack
M=D          // write value of D to current location
@SP          // ** 13: sub ** (pop back to Y, since binary op starts at 1 past Y (SP decremented above))
A=M          // PREPARE Y (pop Y into D)
D=M          // store the top stack value into D
@SP          // "pop" X
M=M-1
...
@SP          // increment stack pointer
M=M+1
@Main.fibonacci$ret.1 // ** 14: call Main.fibonacci 1 **
D=A          // D=retAddr
@SP          // >>> push retAddr onto stack
A=M          // move to top of stack
M=D          // write value of D to current location
...
A=M          // move to top of stack
M=D          // write value of D to current location
@SP          // ** 17: sub ** (pop back to Y, since binary op starts at 1 past Y (SP decremented above))
A=M          // PREPARE Y (pop Y into D)
D=M          // store the top stack value into D
@SP          // "pop" X
M=M-1
...
@SP          // increment stack pointer
M=M+1
@Main.fibonacci$ret.2 // ** 18: call Main.fibonacci 1 **
D=A          // D=retAddr
@SP          // >>> push retAddr onto stack
A=M          // move to top of stack
M=D          // write value of D to current location
...
@Main.fibonacci // jump to the function
0;JMP
@SP          // ** 19: add ** (pop back to Y, since binary op starts at 1 past Y)
M=M-1
A=M          // PREPARE Y (pop Y into D)
D=M          // store the top stack value into D
@SP          // "pop" X
...
@SP          // increment stack pointer
M=M+1
@Main.fibonacci$ret.3 // ** 23: call Main.fibonacci 1 **
D=A          // D=retAddr
@SP          // >>> push retAddr onto stack
A=M          // move to top of stack
M=D          // write value of D to current location
